...
class EpsilonDeltaKriteriumStetigkeitOne(Scene):
    def construct(self):
        #Text
        ...
        text2 = Text("Lass uns zuerst über Intuition reden: ", font_size=36, color=YELLOW)
        ...
        delta_label = MathTex("\\delta").next_to(delta_interval, UP)
        ...
        self.play(Write(text2))  # Animate writing the second text
        self.wait(1)
